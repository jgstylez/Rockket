   ...
   return (
      <div className="h-full flex flex-col gap-6 animate-fade-in">
         <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <GlassCard className="border-orange-200 dark:border-orange-900/30 bg-orange-50 dark:bg-orange-900/10">
               <div className="flex items-center gap-3 mb-4 text-orange-600 dark:text-orange-400">
                  ...
                  <span className="text-sm font-bold uppercase tracking-widest">Upgrade Page Views</span>
               </div>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1 min-h-[300px]">
            ...
            <div>
               <h3 className="font-bold text-slate-900 dark:text-white text-lg mb-6">Automated Sequence</h3>
