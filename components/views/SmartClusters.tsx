...
const SmartClusters: React.FC = () => {
  ...
  // Mock Clusters
  const clusters = [
    { id: 'vip', name: 'High Gravity', count: 142, color: 'bg-emerald-500', desc: 'High open rate + purchases' },
    { id: 'risk', name: 'Drifting', count: 89, color: 'bg-orange-500', desc: 'Inactive > 30 days' },
    { id: 'new', name: 'New Recruits', count: 34, color: 'bg-cyan-500', desc: 'Joined < 7 days ago' },
  ];
  ...
  return (
    <div className="h-full flex flex-col gap-6 animate-fade-in">
      {/* Top: Query Beam */}
      <GlassCard className="p-0 overflow-hidden bg-slate-900 border-slate-700 shadow-xl">
         <div className="p-4 bg-indigo-900/20 border-b border-indigo-500/30 flex items-center gap-3">
            <Sparkles className="text-indigo-400" size={18} />
            <span className="text-xs font-bold text-indigo-400 uppercase tracking-widest">Natural Language Segmenter</span>
         </div>
         <div className="p-6 flex gap-4">
            <div className="flex-1 relative">
               ...
               <input 
                 ...
                 className="w-full bg-slate-800 border border-slate-700 rounded-xl pl-12 pr-4 py-3 text-white placeholder:text-slate-500 focus:ring-2 focus:ring-indigo-500 outline-none font-mono text-sm"
               />
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1 min-h-[400px]">
         ...
         <div className="space-y-4">
            <h3 className="font-bold text-slate-900 dark:text-white flex items-center">
               <Filter size={18} className="mr-2 text-indigo-500" /> Auto-Clusters
            </h3>
            ...
            <GlassCard className="border-red-200 dark:border-red-900/30 bg-red-50 dark:bg-red-900/10 mt-6">
               <div className="flex items-center gap-2 mb-2 text-red-600 dark:text-red-400 font-bold">
                  <Trash2 size={16} /> Ghost Protocol
               </div>
               <p className="text-xs text-slate-600 dark:text-slate-400 mb-4">
                  Identify and archive 12 "dead" contacts to improve sender reputation.
               </p>
         ...
         <GlassCard className="lg:col-span-2 bg-slate-950 border-slate-800 relative overflow-hidden flex flex-col">
            ...
            <div className="relative z-10 flex-1">
               <div className="absolute top-4 left-4">
                  <h3 className="text-white font-bold flex items-center">
                     <Users size={18} className="mr-2 text-cyan-400" /> Audience Nebula
                  </h3>
                  <p className="text-xs text-slate-500 font-mono mt-1">Real-time behavior map</p>
               </div>
            ...
            <div className="relative z-10 pt-4 border-t border-slate-800 flex gap-4 text-xs font-mono">
               <div className="flex items-center text-slate-400">
                  <div className="w-2 h-2 rounded-full bg-emerald-400 mr-2"></div> VIP
               </div>
               <div className="flex items-center text-slate-400">
